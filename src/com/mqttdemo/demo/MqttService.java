...
public class MqttService extends Service implements MqttCallback
{
    ...
    private static final String MQTT_BROKER = "www.yunxnet.com"; // Broker URL or IP Address
    ...
    private static final int MQTT_KEEP_ALIVE = 60000; // KeepAlive Interval in MS
    private static final String MQTT_KEEP_ALIVE_TOPIC_FORAMT = "/users/%s/keepalive"; // Topic format for KeepAlives
    private static final String MQTT_TOPIC_WEB_SERVIER = "$client/C_1487059336575";
    ...
    private static final String ACTION_PUSH_MSG= DEBUG_TAG + ".PUSHMSG";
    ...
    public static void actionPushMsg(Context ctx){
    	  Intent i = new Intent(ctx,MqttService.class);
          i.setAction(ACTION_PUSH_MSG);
          ctx.startService(i);
    }
...
//            }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
            ...
            if(action == null) {
                    ...
                    }else if(action.equals(ACTION_PUSH_MSG)){
                    	sendPushMessage("开始");
                    }
            }
...
//    	}
       ...
       mConnHandler.postDelayed(new Runnable() {
    ...
    private synchronized void sendPushMessage(String msg){
    		msg = "你是："+Math.random()*10000;
    	  MqttMessage message = new MqttMessage();
    	  message.setPayload(msg.getBytes());
    	  message.setRetained(false);
    	  message.setQos(MQTT_QOS_0);
          if(mClient!=null){
        	  MqttTopic mqttTopic = mClient.getTopic(MQTT_TOPIC_WEB_SERVIER);
        	  try {
